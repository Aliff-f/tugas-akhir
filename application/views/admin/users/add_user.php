...
<head>
    ...
    <title>Tambah Pengguna - Neo Admin</title>
    ...
    <style>
        body {
            ...
            /* Dot pattern background removed as requested */
        }
        ...
        .neo-radio-group input:checked + span {
            ...
            color: white;
            border-color: #09090b;
            box-shadow: 2px 2px 0px 0px #9ca3af;
        }
    </style>
</head>
    ...
    <div class="w-full max-w-5xl space-y-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-zinc-600 font-medium mt-2 text-lg">Kelola akun, identitas, dan hak akses pengguna baru.</p>
            </div>
        ...
        <div class="neo-card">
             <div class="bg-neo-black text-white px-6 py-3 flex items-center justify-between border-b-2 border-black">
                <span class="font-mono font-bold text-sm tracking-widest">USER-REGISTRATION</span>
                <div class="flex gap-2">
                    <div class="w-3 h-3 bg-red-500 rounded-full border border-white"></div>
                    <div class="w-3 h-3 bg-yellow-400 rounded-full border border-white"></div>
                </div>
            </div>

            <div class="p-6 md:p-10">
                <form action="<?php echo site_url('Admin/add_users_action') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div class="lg:col-span-4 flex flex-col">
                            ...
                            <div class="upload-zone flex-grow rounded-xl cursor-pointer flex flex-col items-center justify-center p-4 text-center min-h-[300px] group relative overflow-hidden bg-white" 
                                ...
                                <div id="uploadPlaceholder" class="flex flex-col items-center justify-center transition-all duration-300 group-hover:scale-105">
                                ...
                                <img id="imgPreview" class="hidden w-full h-full object-cover rounded-lg absolute inset-0 p-2 z-10 bg-white" alt="Preview">
                                
                                <div id="hoverOverlay" class="hidden absolute inset-0 bg-black/10 flex flex-col items-center justify-center z-20 pointer-events-none">
                        ...
                        <div class="lg:col-span-8 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="password" class="neo-label">Kata Sandi</label>
                                    <input type="password" id="password" name="password" 
                                           class="neo-input" placeholder="********" autocomplete="off" required>
                                </div>
                                <div>
                                    <label for="new_password" class="neo-label">Konfirmasi Sandi</label>
                            ...
                            <div>
                                ...
                                <div class="flex gap-4 neo-radio-group">
                                    <label class="flex-1">
                                        ...
                                        <span class="flex items-center justify-center w-full py-3 border-2 border-zinc-300 rounded-lg font-bold text-zinc-500 hover:border-black">
                    ...
                    <div class="my-8 border-t-2 border-dashed border-zinc-300"></div>
                    <h3 class="text-xl font-black uppercase mb-6 flex items-center">
                        <span class="bg-neo-yellow px-2 mr-2 border-2 border-black shadow-[2px_2px_0_0_#000]">INFO</span> Detail Alamat
                    </h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                        <div>
                            <label class="neo-label">Provinsi</label>
                            <input type="text" name="province" class="neo-input" placeholder="Jawa Timur">
                        </div>
                        <div>
                            <label class="neo-label">Kota/Kabupaten</label>
                            <input type="text" name="city" class="neo-input" placeholder="Surabaya">
                        </div>
                        <div>
                            <label class="neo-label">Kecamatan</label>
                            <input type="text" name="district" class="neo-input" placeholder="Benowo">
                        </div>
                        <div>
                            <label class="neo-label">Kelurahan</label>
                            <input type="text" name="subdistrict" class="neo-input" placeholder="Sememi">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="street" class="neo-input" placeholder="Jl. Bandarejo Asri No. 12">
                        </div>
                        <div>
                            <label class="neo-label">Kode Pos</label>
                            <input type="text" name="zip_code" class="neo-input" placeholder="50123">
                        </div>
                    </div>

                    <div class="mt-6">
                        <label class="neo-label">Deskripsi Tambahan</label>
                        <textarea name="description" rows="3" class="neo-input resize-none" placeholder="Catatan tambahan (Opsional)..."></textarea>
                    </div>
